               ...
               <div class='carousel-inner'>
                  <div class='carousel-item active'>
                     ...
                     <div class='contact_bt_main'>
                        <div class='contact_bt'><a href='<?=base_url('contact')?>'>Contact Us</a></div>
                     </div>
                  </div>
                  <div class='carousel-item'>
                     ...
                     <p class='there_text'>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration</p>
                     <div class='contact_bt_main'>
                        <div class='contact_bt'><a href='../pages/contact.html'>Contact Us</a></div>
                     </div>
                  </div>
                  <div class='carousel-item'>
                     <h1 class='furniture_text'>FURNITURE</h1>
      ...
      <footer class="footer_section layout_padding">
         <div class="container">
            ...
            <div class="input-group mb-2 mt-1">
               <span class="input-group-text" id="basic-addon2"><a href="#">Call Us:&emsp;<strong>+01&ensp;123 456 789</strong></a></span>
            </div>
         </div>
      </footer>
      <!--  footer section end -->
